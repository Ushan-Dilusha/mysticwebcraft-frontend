...
function App() {
    return ( <
        ...
        BrowserRouter >
        <
        Routes > { /* add your pages path and link it */ } <
        Route path = "/admin"
        ...
        /> <
        Route path = "/community-add-user"
        element = { < CommunityAddUserPage / > }
        /> <
        ...
        element = { < CommunityUserHomePage / > }
        /> <
        Route path = "/code-complexity"
        element = { < CodeComplexityAnalyzer / > }
        /> <
        /Routes> <
        /BrowserRouter> <
        /div>
