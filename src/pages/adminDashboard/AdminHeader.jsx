...
function AdminHeader(){
    ...
    <div className="sidenav-header">
      ...
      <a className="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        ...
        <span className="ms-1 font-weight-bold text-white">MYSTICWEBCRAFT</span>
      </a>
    </div>
      ...
      <ul className="navbar-nav">
        ...
        <li className="nav-item">
          <a className="nav-link text-white " href="">
            ...
            <span className="nav-link-text ms-1">Image to text Generater</span>
          </a>
        </li>
        <li className="nav-item">
          <a className="nav-link text-white " href="">
            <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i className="material-icons opacity-10">menu</i>
            </div>
            <span className="nav-link-text ms-1">Code Complexity</span>
          </a>
        </li>
        <li className="nav-item">
          <a className="nav-link text-white " href="">
      ...
      <div className="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li className="breadcrumb-item text-sm text-dark active" aria-current="page">Courses</li>
            <li className="breadcrumb-item text-sm text-dark active" aria-current="page">Communities</li>
            <li className="breadcrumb-item text-sm text-dark active" aria-current="page">Questions</li>
          </ol>
          <h6 className="font-weight-bolder mb-0">Users</h6>
        </nav>
