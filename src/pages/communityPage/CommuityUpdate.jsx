            ...
            <div className="flex justify-center">
                <div className="w-full max-w-xl mt-10">
                    ...
                    >
                        ...
                        <Form.Item
                            name="title"
                            rules={[{ required: true, message: 'Please enter community title!' }]}
                        >
                        ...
                        <Form.Item
                            name="problem"
                            rules={[{ required: true, message: 'Please enter community problem!' }]}
                        >
                        ...
                        <Form.Item
                            name="expecting"
                            rules={[{ required: true, message: 'Please enter community expectations!' }]}
                        >
                        ...
                        <Form.Item>
                            <Button
                                ...
                                htmlType="submit"
                                loading={loading}
                                style={{ backgroundColor: '#1d4ed8', borderColor: '#000000', color: '#ffffff' }}
                            >
                                Update
                            </Button>
                        </Form.Item>
