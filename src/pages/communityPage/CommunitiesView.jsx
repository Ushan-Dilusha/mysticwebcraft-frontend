        ...
        <>
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="flex justify-end mt-8">
                    ...
                    >Add Community Questions</Button>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {communities.map(community => (
                        <div key={community._id} className="rounded-lg overflow-hidden bg-white shadow-md p-4">
                            <div className="flex items-center mb-4">
                                <Avatar src="https://jooinn.com/images/model-photo-3.jpg" size={64} />
                                <div className="ml-4">
                                    <p className="font-bold">{community.title.substring(0, 40)}...</p>
                            ...
                            {community.tags && (
                                <p className="text-sm text-gray-500 mb-2">Tags: {community.tags.join(', ')}</p>
                            )}
                            {community.languages && (
                                <p className="text-sm text-gray-500 mb-2">Languages: {community.languages.join(', ')}</p>
                            )}
                            <div className="flex justify-between">
                                ...
                                <Popconfirm
                                    ...
                                    okButtonProps={{ style: { backgroundColor: '#FFFFFF', color: 'blue' } }}
                                    cancelButtonProps={{ style: { backgroundColor: '#FFFFFF', color: 'red' } }}
                                >
                                    <Button
                                        type="danger"
